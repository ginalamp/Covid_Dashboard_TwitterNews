...
head(national_lockdown$date_start[1])
color_dat = data.frame(time = seq(national_lockdown$date_start[1], national_lockdown$date_end[1], by = "1 day") )
...
ggplot(confirmed_summary, aes(date)) +
  ...
  geom_col(aes(y = daily_confirmed, colour = "Active Cases"), color = "lightblue") +
  geom_line(aes(y = rolling_avg, colour = "Confirmed Cases"), color = "black") +
