...
level_colours <- c("Level 1"="grey","Level 2"="grey47", "Level 3"= "grey41", "Level 4"="grey35", "Level 5"="grey29")
...
ggplot(confirmed_summary, aes(date)) +
  ...
  geom_segment(data = segment1,
          aes(x = time, xend = time,
              y = 0, yend = Inf),
            show.legend = FALSE, colour="grey29") +
  ...
  geom_segment(data = segment3,
        aes(x = time, xend = time,
            y = 0, yend = Inf),
          show.legend = FALSE, colour="grey41") +
  geom_segment(data = segment4,
        aes(x = time, xend = time,
            y = 0, yend = Inf),
          show.legend = FALSE, colour="grey47") +
  geom_segment(data = segment5,
        aes(x = time, xend = time,
            y = 0, yend = Inf),
          show.legend = FALSE, colour="grey") +
  ...
  geom_col(aes(y = daily_confirmed, colour = "Active Cases", fill="green"), color = "black") +
  geom_line(aes(y = rolling_avg, colour = "Confirmed Cases"), color = "red") +
...
# Doubling rates (help plz)
TODO
* Not entirely sure how to calculate this (I think we need to calculate the number of days it takes for the confirmed cases and the deaths to double - unsure about timeline)

<!-- ```{r} -->
<!-- ggplot(active_confirmed_summary, aes(date)) +  -->
<!--   geom_line(aes(y = daily_deaths, colour = "Death")) +  -->
<!--   geom_line(aes(y = daily_confirmed, colour = "Confirmed Cases")) + -->
<!--   labs(title= "Doubling rates", -->
<!--      caption = "Updated: June 2021", -->
<!--      x = NULL, -->
<!--      y = NULL) + -->
<!--   theme_minimal() -->
