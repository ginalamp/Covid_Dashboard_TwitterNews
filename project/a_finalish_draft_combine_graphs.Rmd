...
# head(total)
# table(total)
#   value = paste(format(total, big.mark = ","), " (+ ", confirmed_day_update,")", sep = ""),
#   # caption = "CONFIRMED CASES",
#   # icon = "fas fa-user-md",
#   # color = maroon
# )
...
<!--           options = list(pageLength = 10, lengthMenu = c(5, 10, 15, 20, 25, 30),  -->
<!--                          autoWidth = TRUE, columnDefs = list(list(className = 'dt-center',  -->
<!-- targets = "_all")))) -->
<!-- #               filter = "top", rownames = FALSE, caption = "Customer sum", selection =  -->
<!-- # 'single') %>%  -->
<!-- #   formatRound(columns = 1:6, digits = 1) %>%  -->
<!-- #   formatCurrency(columns = 1:6, currency = "$ ") -->
<!-- ``` -->
