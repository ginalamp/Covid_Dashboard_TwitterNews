...
```{r total deaths and fatality rate}
...
# missing covid deaths per metro for comparison
...
```{r fig.height=4, fig.width=12}
# TODO: Add labels (total active per province)
