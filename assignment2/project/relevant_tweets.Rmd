...
ggplot() +
  geom_histogram(all_tweets_SA %>% mutate(created_at = ymd_hms(created_at)) %>% filter(created_at > ymd_hms("2021-01-01 00:00:00")), mapping = aes(x = created_at, color = "All Tweets"), position = "identity", bins = 30, show.legend = FALSE) +
  geom_histogram(tweets_SA, mapping = aes(x = created_at, color = "Tweets related to Covid"), position = "identity", bins = 30, show.legend = FALSE) +
...
ggplot() +
  geom_histogram(all_tweets_global %>% mutate(created_at = ymd_hms(created_at)) %>% filter(created_at > ymd_hms("2021-01-01 00:00:00")), mapping = aes(x = created_at, color = "All Tweets"), position = "identity", bins = 30, show.legend = FALSE) +
  geom_histogram(tweets_global, mapping = aes(x = created_at, color = "Tweets related to Covid"), position = "identity", bins = 30, show.legend = FALSE) +
  scale_y_continuous(limits = c(0, 400)) +
  facet_wrap(~name, ncol = 1) +
  labs(title = "Frequency of Covid-related Tweets for various Global Media Outlets",
       x = "2021", y = "Tweet Count", color = "Tweets") +
