...
ggplot() +
  geom_histogram(govZA_tweets %>% mutate(created_at = as.Date(created_at)), mapping = aes(x = created_at, fill = "All Tweets"), position = "identity", bins = 30, show.legend = TRUE) +
...
ggplot() +
  geom_histogram(all_tweets_SA %>% mutate(created_at = as.Date(created_at)) %>% filter(created_at > as.Date("2021-01-01 00:00:00")), mapping = aes(x = created_at, fill = "All Tweets"), position = "identity", bins = 30, show.legend = FALSE) +
...
ggplot() +
  geom_histogram(all_tweets_global %>% mutate(created_at = as.Date(created_at)) %>% filter(created_at > as.Date("2021-01-01 00:00:00")), mapping = aes(x = created_at, fill = "All Tweets"), position = "identity", bins = 30, show.legend = FALSE) +
