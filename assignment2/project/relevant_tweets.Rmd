...
ggplot() +
  geom_histogram(all_tweets_SA %>% mutate(created_at = as.Date(created_at)) %>% filter(created_at > as.Date("2021-01-01 00:00:00")), mapping = aes(x = created_at, fill = "All Tweets"), position = "identity", bins = 30, show.legend = TRUE) +
  geom_histogram(tweets_SA, mapping = aes(x = created_at, fill = "Tweets related to Covid"), position = "identity", bins = 30, show.legend = TRUE) +
...
ggplot() +
  geom_histogram(all_tweets_global %>% mutate(created_at = as.Date(created_at)) %>% filter(created_at > as.Date("2021-01-01 00:00:00")), mapping = aes(x = created_at, fill = "All Tweets"), position = "identity", bins = 30, show.legend = TRUE) +
  geom_histogram(tweets_global, mapping = aes(x = created_at, fill = "Tweets related to Covid"), position = "identity", bins = 30, show.legend = TRUE) +
  scale_y_continuous(limits = c(0, 400)) +
  facet_wrap(~name, ncol = 1) +
