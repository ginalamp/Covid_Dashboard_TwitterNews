...
CapeTalk_tweets$text[(CapeTalk_tweets$is_retweet)]
CapeTalk_tweets$retweet_count[(CapeTalk_tweets$is_retweet)]
CapeTalk_tweets$favorite_count[(CapeTalk_tweets$is_retweet)]
```
