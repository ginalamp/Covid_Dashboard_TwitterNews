...
number_of_x <- data.frame(name = unlist(lapply(media_outlet_list, function(df) {return(df$name[1])})), 
...
# join name, follower, friend, tweet, and calculated retweet values into a dataframe
global_number_of_x <- data.frame(name = unlist(lapply(global_media_outlet_list, function(df) {return(df$name[1])})),
...
ggplot(number_of_x, aes(name, followers_count, fill=name)) +
  geom_col() +
  labs(title = paste("Number of followers per media outlet", "-- South Africa"),
       x=NULL,
       y=NULL) +
...
# TODO: perhaps remove - not really relevant
ggplot(number_of_x, aes(name, friends_count, fill=name)) +
  geom_col() +
  labs(title = paste("Number of friends per media outlet", "-- South Africa"),
       x=NULL,
       y=NULL) +
  scale_y_continuous(label=comma) +
  scale_fill_manual(values = ms_colors) +
...
ggplot(number_of_x, aes(name, tweets_count, fill=name)) +
  geom_col() +
  labs(title = paste("Number of tweets per media outlet", "-- South Africa"),
       x=NULL,
       y=NULL) +
  scale_y_continuous(label=comma) +
  scale_fill_manual(values = ms_colors) +
...
ggplot(number_of_x, aes(name, user_retweet_sum, fill=name)) +
  geom_col() +
  labs(title = paste("Number of user retweets per media outlet", "-- South Africa"),
       x=NULL,
       y=NULL) +
  scale_y_continuous(label=comma) +
  scale_fill_manual(values = ms_colors) +
...
ggplot(number_of_x, aes(name, outlet_retweet_count, fill=name)) +
  geom_col() +
  labs(title = paste("Number of outlet retweets per media outlet", "-- South Africa"),
       x=NULL,
       y=NULL) +
  scale_y_continuous(label=comma) +
  scale_fill_manual(values = ms_colors) +
...
ggplot(global_number_of_x, aes(name, followers_count, fill=name)) +
  geom_col() +
  labs(title = paste("Number of followers per media outlet", "-- Global"),
       x=NULL,
       y=NULL) +
  scale_y_continuous(label=comma) +
...
# TODO: perhaps remove - not relevant
ggplot(global_number_of_x, aes(name, friends_count, fill=name)) +
  geom_col() +
  labs(title = paste("Number of friends per media outlet", "-- Global"),
       x=NULL,
       y=NULL) +
  scale_y_continuous(label=comma) +
  scale_fill_manual(values = rev(ms_colors)) +
...
ggplot(global_number_of_x, aes(name, tweets_count, fill=name)) +
  geom_col() +
  labs(title = paste("Number of tweets per media outlet", "-- Global"),
       x=NULL,
       y=NULL) +
  scale_y_continuous(label=comma) +
  scale_fill_manual(values = rev(ms_colors)) +
...
ggplot(global_number_of_x, aes(name, user_retweet_sum, fill=name)) +
  geom_col() +
  labs(title = paste("Number of user retweets per media outlet", "-- Global"),
       x=NULL,
       y=NULL) +
  scale_y_continuous(label=comma) +
  scale_fill_manual(values = rev(ms_colors)) +
...
ggplot(global_number_of_x, aes(name, outlet_retweet_count, fill=name)) +
  geom_col() +
  labs(title = paste("Number of outlet retweets per media outlet", "-- Global"),
       x=NULL,
       y=NULL) +
  scale_y_continuous(label=comma) +
  scale_fill_manual(values = rev(ms_colors)) +
