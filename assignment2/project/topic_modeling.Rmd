...
nr_of_topics <- 6 # chosen based on ldatuning 5 or 6
...
nr_of_topics <- 4 # chosen based on ldatuning 4 or 7
...
nr_of_topics <- 3 # chosen based on ldatuning
...
#}
nr_of_topics <- 3 # chosen based on ldatuning
plot_topics_of_org(tidy_tweets_global, "The New York Times", nr_of_topics, GLOBAL_SUFFIX) # TODO: still has overlapping x labels
nr_of_topics <- 3 # chosen based on ldatuning 4 or 7
...
plot_topics_of_org_for_month(tidy_tweets_SA, "SABC News", "2021-06-01", nr_of_topics, SA_SUFFIX)  # TODO: still has overlapping x labels
...
plot_topics_of_org_for_month(tidy_tweets_global, "The Economist", "2021-01-01", nr_of_topics, GLOBAL_SUFFIX)  # TODO: still has overlapping x labels
...
plot_topics_of_org_for_month(tidy_tweets_global, "BBC News (World)", "2021-02-01", nr_of_topics, GLOBAL_SUFFIX)  # TODO: still has overlapping x labels
...
plot_topics_of_org_for_month(tidy_tweets_global, "The Associated Press", "2021-04-01", nr_of_topics, GLOBAL_SUFFIX)  # TODO: still has overlapping x labels
```
...
topics_per_month_list <- list(
  ...
  top_words_per_topic(monthly_topics(tidy_tweets_SA, "2021-06-01", NUM_TOPICS_MONTH), SENTIMENT_WORDS_PER_TOPIC)
)
