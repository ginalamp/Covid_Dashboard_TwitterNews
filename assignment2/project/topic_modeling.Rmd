...
topics_overall <- top_words_per_topic(overall_topics(tidy_tweets_SA, nr_of_topics), SENTIMENT_WORDS_PER_TOPIC)
...
topics_per_month_list <- list(
  top_words_per_topic(monthly_topics(tidy_tweets_SA, "2021-04-01", NUM_TOPICS_MONTH_REDUCED), SENTIMENT_WORDS_PER_TOPIC),
  top_words_per_topic(monthly_topics(tidy_tweets_SA, "2021-05-01", NUM_TOPICS_MONTH), SENTIMENT_WORDS_PER_TOPIC),
...
topics_per_outlet_list <- list(
  top_words_per_topic(org_topics(tidy_tweets_SA, "Daily Maverick", NUM_TOPICS_OUTLET), SENTIMENT_WORDS_PER_TOPIC),
  top_words_per_topic(org_topics(tidy_tweets_SA, "SABC News", NUM_TOPICS_OUTLET_REDUCED), SENTIMENT_WORDS_PER_TOPIC),
  top_words_per_topic(org_topics(tidy_tweets_SA, "Eyewitness News", NUM_TOPICS_OUTLET_REDUCED), SENTIMENT_WORDS_PER_TOPIC),
  top_words_per_topic(org_topics(tidy_tweets_SA, "News24", NUM_TOPICS_OUTLET_REDUCED), SENTIMENT_WORDS_PER_TOPIC)
)
...
topics_per_outlet_month_list <- list(
  top_words_per_topic(monthly_org_topics(tidy_tweets_SA, "Daily Maverick", JUNE1, NUM_TOPICS_OUTLET), SENTIMENT_WORDS_PER_TOPIC),
  top_words_per_topic(monthly_org_topics(tidy_tweets_SA, "SABC News", JUNE1, NUM_TOPICS_OUTLET), SENTIMENT_WORDS_PER_TOPIC),
  top_words_per_topic(monthly_org_topics(tidy_tweets_SA, "Eyewitness News", JUNE1, NUM_TOPICS_OUTLET), SENTIMENT_WORDS_PER_TOPIC),
  top_words_per_topic(monthly_org_topics(tidy_tweets_SA, "News24", JUNE1, NUM_TOPICS_OUTLET), SENTIMENT_WORDS_PER_TOPIC)
)
