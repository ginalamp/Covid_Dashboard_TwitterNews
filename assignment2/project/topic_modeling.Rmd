...
NUM_TOPICS <- 4
NUM_TOPICS_REDUCED <- 2 # some months have less topics due to less data being available
...
topics_per_month_list <- list(
  top_words_per_topic(monthly_topics(tidy_tweets, "2021-04-01", NUM_TOPICS_REDUCED), words_per_topic),
  top_words_per_topic(monthly_topics(tidy_tweets, "2021-05-01", NUM_TOPICS), words_per_topic),
  top_words_per_topic(monthly_topics(tidy_tweets, "2021-06-01", NUM_TOPICS), words_per_topic)
)
...
# set names of topics
topic <- list(1:length(term_per_topic_list))
...
# colnames(overall_sentiment_per_month)[1] = "topic"
