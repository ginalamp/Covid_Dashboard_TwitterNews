...
for (outlet in SA_media_outlets$name) {
  print(plot_topics_of_org_for_month(tidy_tweets_SA, outlet, "2021-01-01", NUM_TOPICS_4, SA_SUFFIX))
}
```
...
for (outlet in SA_media_outlets$name) {
  print(plot_topics_of_org_for_month(tidy_tweets_SA, outlet, "2021-02-01", NUM_TOPICS_4, SA_SUFFIX))
}
```
...
# South Africa - March
for (outlet in SA_media_outlets$name) {
  print(plot_topics_of_org_for_month(tidy_tweets_SA, outlet, "2021-03-01", NUM_TOPICS_4, SA_SUFFIX))
}
```
...
# South Africa - April
for (outlet in SA_media_outlets$name) {
  print(plot_topics_of_org_for_month(tidy_tweets_SA, outlet, "2021-04-01", NUM_TOPICS_4, SA_SUFFIX))
}
```
...
# South Africa - May
for (outlet in SA_media_outlets$name) {
  print(plot_topics_of_org_for_month(tidy_tweets_SA, outlet, "2021-05-01", NUM_TOPICS_4, SA_SUFFIX))
}
```
...
# South Africa - June
for (outlet in SA_media_outlets$name) {
  print(plot_topics_of_org_for_month(tidy_tweets_SA, outlet, "2021-06-01", NUM_TOPICS_4, SA_SUFFIX))
}
```
...
for (outlet in global_media_outlets$name) {
  print(plot_topics_of_org_for_month(tidy_tweets_global, outlet, "2021-01-01", NUM_TOPICS_4, GLOBAL_SUFFIX))
}
```
...
# Global - February
for (outlet in global_media_outlets$name) {
  print(plot_topics_of_org_for_month(tidy_tweets_global, outlet, "2021-02-01", NUM_TOPICS_4, GLOBAL_SUFFIX))
}
```
...
# Global - March
for (outlet in global_media_outlets$name) {
  print(plot_topics_of_org_for_month(tidy_tweets_global, outlet, "2021-03-01", NUM_TOPICS_4, GLOBAL_SUFFIX))
}
```
...
# Global - April
for (outlet in global_media_outlets$name) {
  print(plot_topics_of_org_for_month(tidy_tweets_global, outlet, "2021-04-01", NUM_TOPICS_4, GLOBAL_SUFFIX))
}
```
...
# Global - May
for (outlet in global_media_outlets$name) {
  print(plot_topics_of_org_for_month(tidy_tweets_global, outlet, "2021-05-01", NUM_TOPICS_4, GLOBAL_SUFFIX))
}
```
...
# Global - June
for (outlet in global_media_outlets$name) {
  print(plot_topics_of_org_for_month(tidy_tweets_global, outlet, "2021-06-01", NUM_TOPICS_4, GLOBAL_SUFFIX))
}
```
