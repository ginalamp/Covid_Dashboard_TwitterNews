...
DailyMav_tweets <- extract_relevant_data(read.csv("new_data/dailymaverick.csv"))
EWN_tweets <- extract_relevant_data(read.csv("new_data/ewnupdates.csv"))
News24_tweets <- extract_relevant_data(read.csv("new_data/news24.csv"))
SABCNews_tweets <- extract_relevant_data(read.csv("new_data/sabcnews.csv"))
...
```
```{r read Global data}
nytimes_tweets <- extract_relevant_data(read.csv("new_data/nytimes.csv"))
AP_tweets <- extract_relevant_data(read.csv("new_data/ap.csv"))
bbcworld_tweets <- extract_relevant_data(read.csv("new_data/bbcworld.csv"))
economist_tweets <- extract_relevant_data(read.csv("new_data/theeconomist.csv"))
# combine tweets into a list of dataframes
