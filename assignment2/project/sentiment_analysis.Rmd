...
```{r plot average sentiment per organisation on covid-19}
...
ggplot(top_retweets_sentiment_per_outlet, aes(name, top_retweets_sentiment_mean, fill=name)) +
  geom_col() +
  labs(title = paste("Sentiment of Top", NUM_TWEETS, "retweeted tweets per media outlet", "-- South Africa"),
       x=NULL,
       y="Vader Sentiment Score") +
  scale_fill_manual(values = ms_colors) +
  custom_column_basic_theme()
...
ggplot(top_favourited_sentiment_per_outlet, aes(name, top_favourited_sentiment_mean, fill=name)) +
  geom_col() +
  labs(title = paste("Sentiment of Top", NUM_TWEETS, "favourited tweets per media outlet", "-- South Africa"),
       x=NULL,
       y="Vader Sentiment Score") +
  scale_fill_manual(values = ms_colors) +
  custom_column_basic_theme()
...
ggplot(bind_rows(tidy_tweets, .id="df"), aes(created_at, rolling_avg, colour=name)) + 
  geom_line(size=0.6) +
  labs(title = paste("Sentiment over time per media outlet", "-- South Africa"),
       subtitle = paste("A rolling average of", ROLLING_AVERAGE_TIME, "days is used."),
       color=NULL,
       x = NULL,
       y = "Vader Sentiment Score") +
...
ggplot(global_overall_sentiment_per_outlet, aes(global_name, global_sentiment_mean_per_outlet, fill=global_name)) +
  geom_col() +
  labs(title = paste("Average sentiment per media outlet", "-- Global"),
       x=NULL,
       y="Vader Sentiment Score") +
...
ggplot(global_top_retweets_sentiment_per_outlet, aes(global_name, global_top_retweets_sentiment_mean, fill=global_name)) +
  geom_col() +
  labs(title = paste("Sentiment of Top", NUM_TWEETS, "retweeted tweets per media outlet", "-- Global"),
       x=NULL,
       y="Vader Sentiment Score") +
  scale_fill_manual(values = rev(ms_colors)) +
  custom_column_basic_theme()
...
ggplot(global_top_favourited_sentiment_per_outlet, aes(global_name, global_top_favourited_sentiment_mean, fill=global_name)) +
  geom_col() +
  labs(title = paste("Sentiment over time per media outlet", "-- Global"),
       x=NULL,
       y="Vader Sentiment Score") +
  scale_fill_manual(values = rev(ms_colors)) +
  custom_column_basic_theme()
...
ggplot(bind_rows(global_tidy_tweets, .id="df"), aes(created_at, rolling_avg, colour=name)) + 
  geom_line(size=0.6) +
  labs(title = paste("Sentiment over time per media outlet", "-- Global"),
       subtitle = paste("A rolling average of", ROLLING_AVERAGE_TIME, "days is used."),
       color=NULL,
