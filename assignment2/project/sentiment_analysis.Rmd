...
```{r}
read.csv("data/dailymaverick.csv")
```
...
```{r}
# get top NUM_TWEETS retweeted/favourited tweets per media outlet
...
```{r get top NUM_TWEETS South African retweets and favourited tweets}
...
```
```{r get top NUM_TWEETS Global retweets and favourited tweets}
# TODO need to plot nicely (as table?)
...
<!--     slice(1:NUM_TWEETS) %>%  -->
<!--     select(status_id, name, created_at, retweet_count, text) -->
<!--   return(text) -->
<!-- } -->
...
<!--     slice(1:NUM_TWEETS) %>%  -->
<!--     select(status_id, name, created_at, favorite_count, text) -->
<!--   return(text) -->
<!-- } -->
